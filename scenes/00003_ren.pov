...
union{
  // Hollow stained translucent fuzzy cyan glass box
  difference{
  ...
  // Outer thin shell to boost glassy edges and "fractal stained" appearance
  ...
  // Slight internal glow volume to keep it visible against dark background
